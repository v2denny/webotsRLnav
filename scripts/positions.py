...
def get_positions(mode):
    ...
    # Pool of all initial and final positions
    pool = {
        'initial_positions': [
            (-1.316, 1.312), (-0.813, 1.310), (-0.186, 0.666), (0.186, 0.309), (0.062, 1.435),
            (1.310, 0.681), (-1.380, -0.747), (-1.380, -1.085), (-1.380, -0.455), (-0.063, -1.187),
            (-0.253, -0.751), (0.126, -1.369), (0.063, -0.063), (-0.562, 0.187), (-0.066, 0.187),
            (0.769, 0.313), (0.744, 1.368), (1.185, -1.438), (1.190, -0.566)
        ],
        'final_targets': [
            (-1.313, 0.187), (1.311, 0.187), (1.314, 1.311), (-1.063, -0.313), (-1.063, -1.188),
            (1.187, -1.059)
        ]
    }
    ...
    if mode == "easy":
        ...
        initial_position = random.choice(pool['initial_positions'])
        final_position = random.sample(pool['final_targets'], num_targets)
